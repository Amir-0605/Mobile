        ...
        <div className='bg-[linear-gradient(45deg,#FFFFFF_0%,#99999999_100%)] inset-0 bg-black/70 pt-10 sm:pt-16 lg:pt-25 pb-10'>
            <div className='container mx-auto px-4 sm:px-6 lg:px-0'>
                <div>
                    ...
                    <h1 className='text-[#29494C] text-2xl sm:text-3xl lg:text-4xl font-bold border-b border-[#29494C] pb-3 sm:pb-4'>
                        Северо-Западный Крым: Побережье первозданных смыслов
                    </h1>

                    <h2 className='text-[#29494C] text-xl sm:text-2xl lg:text-3xl mt-2'>
                    ...
                    <div className="max-w-6xl mx-auto py-6 sm:py-10 lg:hidden px-2 sm:px-4">
                        ...
                        >
                            ...
                            <SwiperSlide>
                                <div className="bg-white/50 min-h-[480px] sm:h-[520px] p-3 sm:p-4 rounded-2xl text-[#29494C]">
                                    <img src={img4} alt="img" loading='lazy' className='filter brightness-95 contrast-90 saturate-90 sepia-[0.05]' />
                            ...
                            <SwiperSlide>
                                <div className="bg-white/50 min-h-[480px] p-3 sm:p-4 rounded-2xl text-[#29494C]">
                                    <h1 className='text-lg sm:text-xl pt-4 text-center'>
                                        Заповедная тишина: Встречи с дикой природой
                                    </h1>
                                    <p className='text-sm sm:text-base pt-3'>
                                        Наши массивы граничат с уникальными природными парками. Это место, где дельфины и скаты подплывают к самому берегу, не боясь людей, а небо расцвечивают стаи редких перелетных птиц. Здесь вы живете в ритме природы, а не городского шума.</p>
                                    <img src={img5} alt="img" loading='lazy' className='filter brightness-95 contrast-90 saturate-90 sepia-[0.05]' />
                                </div>
                            </SwiperSlide>

                            <SwiperSlide>
                                <div className="bg-white/50 min-h-[480px] p-3 sm:p-4 rounded-2xl text-[#29494C]">
                                    <img src={img6} alt="img" loading='lazy' className='filter brightness-95 contrast-90 saturate-90 sepia-[0.05]' />
                                    <h1 className='text-lg sm:text-xl pt-4 text-center'>
                            ...
                            <SwiperSlide>
                                <div className="bg-white/50 min-h-[480px] p-3 sm:p-4 rounded-2xl text-[#29494C]">
                                    ...
                                    <p className='text-sm sm:text-base pt-3'>
                                        Забудьте о гальке и резкой глубине. Здесь вас ждут бесконечные пляжи с мягким светлым песком и лазурная мелководная акватория. Вода прогревается на 2–3 недели раньше, чем на Южном берегу, оставаясь комфортной для купания до глубокой осени. Это идеальный берег для тех, кто ценит простор и тепло </p>
                                    <img src={img7} alt="img" loading='lazy' className='filter brightness-95 contrast-90 saturate-90 sepia-[0.05]' />
                                </div>
                            </SwiperSlide>
                    ...
                    <div className="hidden lg:block max-w-6xl mx-auto mt-10 px-2 lg:px-0">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                            ...
                            <div className="bg-white/50 p-3 sm:p-4 rounded-2xl text-[#29494C]">
                                <img src={img4} alt="img" loading='lazy' />
                                <h1 className='text-lg sm:text-xl pt-4 text-center filter brightness-95 contrast-90 saturate-90 sepia-[0.05]'>
                                    Природная здравница: Магия соленых озер
                                </h1>
                                <p className='text-sm sm:text-base pt-3'>
                                    Регион богат лиманами с целебными грязями и рапой, не уступающими по составу Мертвому морю. Сочетание степного разнотравья и морского бриза создает естественный ингаляторий прямо у вашего порога. Это локация, которая лечит самим своим воздухом.
                        ...
                        {/* hidden cards */}
                        <div
                            className={`grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 transition-all duration-700 overflow-hidden ${open ? "max-h-[1200px] opacity-100 mt-6" : "max-h-0 opacity-0"
                                }`}
                        >
